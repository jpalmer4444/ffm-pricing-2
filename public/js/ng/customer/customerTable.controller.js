(function () {
  ...
  angular
          .module('customer')
          .controller('CustomerTableController', ['$scope', '$filter', '$compile', '$http', 'DTOptionsBuilder', 'DTColumnBuilder', 'config', 'screenService', CustomerTableController]);

  function CustomerTableController($scope, $filter, $compile, $http, DTOptionsBuilder, DTColumnBuilder, config, screenService) {
