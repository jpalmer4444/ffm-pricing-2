(function () {
  ...
  angular
          .module('product')
          .controller('ProductTableController', ['$scope', '$filter', '$compile', '$http', 'DTOptionsBuilder', 'DTColumnBuilder', 'config', 'screenService', ProductTableController]);

  function ProductTableController($scope, $filter, $compile, $http, DTOptionsBuilder, DTColumnBuilder, config, screenService) {
